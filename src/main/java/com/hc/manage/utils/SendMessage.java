...
public class SendMessage {
    ...
    public static void main(String[] args) {
        ...
        Integer resultCode = SendMessage.send("hhc0727","d41d8cd98f00b204e980","13247550575",getRandomCode(6));
        System.out.println("生成验证码："+SendMessage.getMessage(resultCode));
    }
